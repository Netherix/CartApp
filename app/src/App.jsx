    ...
    <>
      ...
      <div className="cart-container">
        <div className="cart-wrapper">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" className="cart-icon" onClick={handleModal}>
      ...
      {/* popup window */}
      {isModalOpen && <CartModal closeModal={handleModal} cart={cart} setCart={setCart} />} 
    </>
  );
};
